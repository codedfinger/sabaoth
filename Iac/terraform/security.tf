...
# Create a security group for the public instances (from load balancer to ec2 instance)
...
# Create a security group for the private instances (from load balancer to ec2 instance)
