...
SSH_KEY="$SSH_PRIVATE_KEY"  # Replace with the path to your SSH key file
...
ssh -o StrictHostKeyChecking=no -i "$SSH_KEY" -v ubuntu@"$INSTANCE_IP" "cd /home/ubuntu/backend && npm install && pm2 start index.js"
